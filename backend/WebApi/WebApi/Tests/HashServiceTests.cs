...
public class HashServiceTests
{
    ...
    public void GetHash_WhenCalled_ReturnsHashedString(string? password, string expected)
    {
        ...
        string result = hashService.GetSha256Hash(password);
    ...
    [Test]
    public void GetHash_NullPassword_ThrowsArgumentNullException()
    {
        var hashService = MakeHashService();

        TestDelegate testDelegate = () => hashService.GetSha256Hash(null);
